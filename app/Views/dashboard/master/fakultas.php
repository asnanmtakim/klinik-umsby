                    ...
                    <div class="card-header align-items-center d-flex">
                        ...
                        <?php if (auth()->user()->can('admin.master.manage')): ?>
                            <div class="flex-shrink-0">
                                <button class="btn btn-sm btn-success action-sync" data-url="<?= url_to('master-fakultas-sync'); ?>"><i class="ri-refresh-line fs-14 align-middle"></i> Sinkronisasi Data</button>
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="tb-data" class="table table-bordered table-striped align-middle" data-url="<?= url_to('master-fakultas-all'); ?>">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Nama Fakultas</th>
...
<div class="modal zoomIn fade" id="dataModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="dataModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="form-data" action="<?= url_to('master-fakultas-save'); ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                <label for="singkatan_fakultas" class="form-label">Singkatan <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="singkatan_fakultas" id="singkatan_fakultas" placeholder="Singkatan">
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="<?= base_url('/assets/js/pages/master-fakultas.init.js'); ?>"></script>
<?= $this->endSection() ?>