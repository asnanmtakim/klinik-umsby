!(function () {
   ...
   function i() {
      ...
      !t ||
         ...
         ((n = document.createElement("ul")).innerHTML = '<a href="#" class="logo"><img src="/uploads/site/umsby.png" alt="" height="22"></a>'),
         ...
         (e = e = "/" == location.pathname ? "/" : location.pathname) &&
         ...
         Array.from(document.querySelector("#two-column-menu ul").querySelectorAll("li a")).forEach(function (a) {
            var n = (n = "/" == location.pathname ? "/" : location.pathname);
         ...
         e =
            (e < 1025 && 767 < e
               ? (document.body.classList.remove("twocolumn-panel"),
                 "twocolumn" == sessionStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "twocolumn"), document.getElementById("customizer-layout03") && document.getElementById("customizer-layout03").click(), i(), u(), s()),
   ...
   function O() {
      ...
      (767 < e && document.querySelector(".hamburger-icon").classList.toggle("open"),
         ...
         "vertical" === document.documentElement.getAttribute("data-layout") &&
            (e <= 1025 && 767 < e
               ? (document.body.classList.remove("vertical-sidebar-enable"), "sm" == document.documentElement.getAttribute("data-sidebar-size") ? document.documentElement.setAttribute("data-sidebar-size", "") : document.documentElement.setAttribute("data-sidebar-size", "sm"))
               : 1025 < e
                 ? (document.body.classList.remove("vertical-sidebar-enable"), "lg" == document.documentElement.getAttribute("data-sidebar-size") ? document.documentElement.setAttribute("data-sidebar-size", "sm") : document.documentElement.setAttribute("data-sidebar-size", "lg"))
   ...
   function u() {
      ...
      var e,
         t,
         a = "/" == location.pathname ? "/" : location.pathname;
      (a = a) &&
   ...
   function g() {
      var e = "/" == location.pathname ? "/" : location.pathname;
      (e = e) &&
            ...
            default:
               sessionStorage.getItem("data-body-image") && "img-1" == sessionStorage.getItem("data-body-image")
                  ? (sessionStorage.setItem("data-body-image", "img-1"),
                    ...
                    document.getElementById("theme-settings-offcanvas") && document.getElementById("sidebar-img") && ((document.getElementById("sidebar-img").style.display = "none"), document.documentElement.removeAttribute("data-sidebar-image")))
      ...
      document.getElementsByClassName("notification-check") &&
         ...
         document.getElementById("removeNotificationModal").addEventListener("show.bs.modal", function (e) {
            document.getElementById("delete-notification").addEventListener("click", function () {
               deleteNotification(document.getElementById("delete-notification").getAttribute("data-url"));
